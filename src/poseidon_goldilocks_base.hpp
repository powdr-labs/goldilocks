#ifndef POSEIDON_GOLDILOCKS_BASE
#define POSEIDON_GOLDILOCKS_BASE
...
private:
    ...
    inline void static add_avx( simde__m256i &st0,  simde__m256i &st1,  simde__m256i &st2, const Goldilocks::Element C[SPONGE_WIDTH]);
    inline void static pow7_avx( simde__m256i &st0,  simde__m256i &st1,  simde__m256i &st2);
    inline void static add_avx_a( simde__m256i &st0,  simde__m256i &st1,  simde__m256i &st2, const Goldilocks::Element C[SPONGE_WIDTH]);
    inline void static add_avx_small( simde__m256i &st0,  simde__m256i &st1,  simde__m256i &st2, const Goldilocks::Element C[SPONGE_WIDTH]);
