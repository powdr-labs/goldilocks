#ifndef GOLDILOCKS_FIELD_BASE
#define GOLDILOCKS_FIELD_BASE
...
public:
    ...
    */
    ...
    /*
        AVX operations
    */
    static void set_avx(simde__m256i &a, const Goldilocks::Element &a3, const Goldilocks::Element &a2, const Goldilocks::Element &a1, const Goldilocks::Element &a0);

    static void load_avx(simde__m256i &a_, const Goldilocks::Element *a4);
    static void load_avx(simde__m256i &a_, const Goldilocks::Element &a);
    static void load_avx(simde__m256i &a_, const Goldilocks::Element *a4, uint64_t stride_a);
    static void load_avx(simde__m256i &a_, const Goldilocks::Element *a4, const uint64_t stride_a[4]);
    static void load_avx_a(simde__m256i &a, const Goldilocks::Element *a4_a);

    static void store_avx(Goldilocks::Element *a4, const simde__m256i &a);
    static void store_avx(Goldilocks::Element *a4, uint64_t stride_a, const simde__m256i &a);
    static void store_avx(Goldilocks::Element *a4, const uint64_t stride_a[4], const simde__m256i &a);
    static void store_avx_a(Goldilocks::Element *a4_a, const simde__m256i &a);

    static void shift_avx(simde__m256i &a_s, const simde__m256i &a);
    static void toCanonical_avx(simde__m256i &a_c, const simde__m256i &a);
    static void toCanonical_avx_s(simde__m256i &a_sc, const simde__m256i &a_s);

    static void add_avx(simde__m256i &c, const simde__m256i &a, const simde__m256i &b);
    static void add_avx_a_sc(simde__m256i &c, const simde__m256i &a_c, const simde__m256i &b);
    static void add_avx_s_b_small(simde__m256i &c_s, const simde__m256i &a_s, const simde__m256i &b_small);
    static void add_avx_b_small(simde__m256i &c, const simde__m256i &a, const simde__m256i &b_small);
    static void sub_avx(simde__m256i &c, const simde__m256i &a, const simde__m256i &b);
    static void sub_avx_s_b_small(simde__m256i &c_s, const simde__m256i &a_s, const simde__m256i &b_small);

    static void mult_avx(simde__m256i &c, const simde__m256i &a, const simde__m256i &b);
    static void mult_avx_8(simde__m256i &c, const simde__m256i &a, const simde__m256i &b);

    static void mult_avx_128(simde__m256i &c_h, simde__m256i &c_l, const simde__m256i &a, const simde__m256i &b);
    static void mult_avx_72(simde__m256i &c_h, simde__m256i &c_l, const simde__m256i &a, const simde__m256i &b);
    static void reduce_avx_128_64(simde__m256i &c, const simde__m256i &c_h, const simde__m256i &c_l);
    static void reduce_avx_96_64(simde__m256i &c, const simde__m256i &c_h, const simde__m256i &c_l);

    static void square_avx(simde__m256i &c, simde__m256i &a);
    static void square_avx_128(simde__m256i &c_h, simde__m256i &c_l, const simde__m256i &a);

    static Element dot_avx(const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element b[12]);
    static Element dot_avx_a(const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element b_a[12]);

    static void spmv_avx_4x12(simde__m256i &c, const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element b[12]);
    static void spmv_avx_4x12_a(simde__m256i &c, const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element b_a[12]);
    static void spmv_avx_4x12_8(simde__m256i &c, const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element b_8[12]);

    static void mmult_avx_4x12(simde__m256i &b, const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element M[48]);
    static void mmult_avx_4x12_a(simde__m256i &b, const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element M_a[48]);
    static void mmult_avx_4x12_8(simde__m256i &b, const simde__m256i &a0, const simde__m256i &a1, const simde__m256i &a2, const Element M_8[48]);

    static void mmult_avx(simde__m256i &a0, simde__m256i &a1, simde__m256i &a2, const Element M[144]);
    static void mmult_avx_a(simde__m256i &a0, simde__m256i &a1, simde__m256i &a2, const Element M_a[144]);
    static void mmult_avx_8(simde__m256i &a0, simde__m256i &a1, simde__m256i &a2, const Element M_8[144]);

    // implementations for expressions:
    static void op_avx(uint64_t op, simde__m256i &c_, const simde__m256i &a_, const simde__m256i &b_);

    static void copy_avx(Element *dst, const Element &src);
    static void copy_avx(Element *dst, const Element *src);
    static void copy_avx(simde__m256i &dst_, const Element &src);
    static void copy_avx(simde__m256i &dst_, const simde__m256i &src_);
